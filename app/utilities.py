...
def build_program(program_path):
    ...
    compile_command += "export CREPAIR_CC=/CrashRepair/compiler/crepair-cc; export CREPAIR_CXX=/CrashRepair/compiler/crepair-cxx;" \
                      "CC=\"$CREPAIR_CC\" CXX=\"CREPAIR_CXX\" make -e;" \
