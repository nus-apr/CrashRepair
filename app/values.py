...
TIME_TO_EXPLORE = 0
TIME_TO_REDUCE = 0
TIME_CONCOLIC_ANALYSIS = 0
TIME_CONCRETE_ANALYSIS = 0
...
DEFAULT_SYNTHESIZE_SUBSET_EXPR = True
DEFAULT_MAX_FIX_LOCATIONS = 50
...
CONF_SYNTHESIZE_SUBSET_EXPR = False

TRACE_CONCRETE = list()
TRACE_SYMBOLIC = list()
VALUE_TRACK_CONCRETE = dict()
VALUE_TRACK_SYMBOLIC = dict()
MEMORY_TRACK_CONCRETE = dict()
MEMORY_TRACK_SYMBOLIC = dict()
POINTER_TRACK_CONCRETE = dict()
POINTER_TRACK_SYMBOLIC = dict()
AST_OFFSET_MAP = dict()
...
def get_file_message_log():
    return get_dir_klee_last() + "/messages.txt"

def get_file_trace_log():
    return get_dir_klee_last() +  "/trace.log"

def get_file_ppc_log():
    return get_dir_klee_last() + "/ppc.log"

def get_file_expr_log():
    return get_dir_klee_last() +  "/expr.log"
